...
class Company_crud:
    ...
    async def create_company(self, company: company_schemas.Company, owner_id: int):
    ...
    async def add_to_admins_in_company(self, company_id: int, user_id: int):
    ...
    async def get_company(self, owner_id):
    ...
    async def show_requests_from_users(self, company_id: int):
    ...
    async def update_company(self, company: company_schemas.UpdateCompany):
    ...
    async def delete_user_from_company(self, user_id: int, company_id: int):
