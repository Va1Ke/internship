...
class InvitationFromOwner_crud:
    ...
    async def create_invitation(self, inventation: invitation_from_owner_schemas.InvitationAdd, db: databases.Database):
    ...
    async def get_invitation_by_id(self, id: int, db: databases.Database):
    ...
    async def get_invitation_by_invented_id(self, id: int, db: databases.Database):
    ...
    async def accept_invitation(self, invitation_id: int, company_id: int, user_id: int, db: databases.Database):
    ...
    async def delete_user_from_company(self, company_id: int, user_id: int, db: databases.Database):
    ...
    async def decline_invitation(self, invitation_id: int, db: databases.Database):
