...
class QuizQuestions_crud:
    ...
    async def add_question(self, question: quiz_questions_schemas.QuizQuestionEntry, db: databases.Database) -> quiz_questions_schemas.QuizQuestionReturn:
    ...
    async def get_question_by_id(self, id: int, db: databases.Database) -> quiz_questions_schemas.QuizQuestionReturn:
    ...
    async def delete_question_for_quiz_crud(self, quiz_id: int, db: databases.Database) -> HTTPException:
    ...
    async def delete_question(self, quiz_id: int, question_id: int, db: databases.Database) -> HTTPException:
